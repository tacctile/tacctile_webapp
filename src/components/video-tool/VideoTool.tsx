...
import { FlagEditModal } from "@/components/timeline/FlagEditModal";
...
const videoFiles = [
  ...
  },
  {
    id: "v4",
    type: "video" as const,
    fileName: "handheld_investigation.mp4",
    duration: 2400,
...
const mockFlags: Flag[] = [
  {
    ...
    note: "Dark figure moves across doorway, left to right. Approximately 2 seconds duration.",
    createdBy: "Sarah",
  ...
  },
  {
    ...
    timestamp: 1337000,
    label: "Audio anomaly",
    note: "Possible voice, sounds like whisper.",
    createdBy: "Mike",
...
export const VideoTool: React.FC<VideoToolProps> = ({ investigationId }) => {
  ...
  const handleFilterChange =
    (filter: keyof typeof defaultFilters) =>
  ...
  const mainContent = (
    ...
    >
      ...
      >
        {loadedVideo ? (
          ...
          >
            ...
            <Typography sx={{ fontSize: 12, color: "#444", mt: 0.5 }}>
              {isFileDragOver
                ? "Release to import"
                : "Drag & drop or click to import video files"}
            </Typography>
          ...
          >
            <Tooltip title="Add flag (M)">
              <IconButton
                ...
                sx={{ color: "#888", backgroundColor: "rgba(0,0,0,0.5)" }}
              >
        ...
        {/* Flag Edit Modal - centered in video workspace area */}
        <FlagEditModal
          flag={editingFlag}
      ...
      >
        ...
        >
          <Typography
            sx={{ fontSize: 10, color: "#555", fontFamily: "monospace" }}
          >
        ...
        >
          <Typography sx={{ fontSize: 10, color: "#666", width: 50 }}>
            VIDEO
          </Typography>
          <Box
            sx={{
      ...
      {/* Volume controls - positioned above transport */}
      <Box
        sx={{
          height: 32,
          backgroundColor: "#1a1a1a",
      ...
      >
        <Box sx={{ padding: "8px 12px" }}>
          ...
          <PrecisionSlider
            ...
            unit="%"
            onChange={(v) =>
              setFilters((prev) => ({ ...prev, nightVision: v }))
            }
            disabled={!loadedVideo}
          />
          <PrecisionSlider
