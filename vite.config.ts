  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: "Tacctile",
        description:
          "Professional evidence analysis and investigation management",
        theme_color: "#19abb5",
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            urlPattern:
              /^https:\/\/fonts\.googleapis\.com\/css2\?family=Material\+Symbols.*/i,
            handler: "CacheFirst",
            options: {
    ...
    // Bundle analyzer - generates stats.html with chunk visualization
    visualizer({
      open: true,
      filename: "stats.html",
      gzipSize: true,
    ...
    rollupOptions: {
      output: {
        ...
        assetFileNames: (assetInfo) => {
          ...
          if (
            assetInfo.name &&
            /\.(woff2?|ttf|otf|eot)$/i.test(assetInfo.name)
          ) {
